...
echo '-=Download=-'
azcopy --source $INSTALLER_SAS --destination /tmp/mtoa/MtoA-linux-2019.run

echo '-=Extract and Install=-'
7za x /tmp/mtoa/MtoA-linux-2019.run -o/tmp/mtoa/
7za x /tmp/mtoa/MtoA-linux-2019 -o/tmp/mtoa/MtoA2019
